...
/*hp:move enum from friendlist.c*/
enum{
	FRIEND_PRESENCE_IMG,
	FRIEND_NAME,
...
void *hp_update_ip(void *t);
void hp_updateip_handler(int sig);
int hp_catch_signal(int sig, void (*handler)(int));
void ui_config_read(LinphoneCore *lc);

/*....................................create by dc......................................*/

void dc_sendfile_clicked(GtkWidget *button);
void dc_filechooser_quit(GtkWidget *button);
void dc_filechooser_ok(GtkWidget *button);
